...
{
    /// <summary>
    /// OpenH264 原生 API — x86 (32-bit) P/Invoke 实现。
    /// DLL 位于 appBase/openh264/x86/openh264.dll
    /// </summary>
    internal static class H264NativeArchX86
    {
        private const string DllPath = "openh264\\x86\\openh264.dll";
